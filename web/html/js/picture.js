$(function() {
	$(".photo-nav li:first").addClass("actives");
    $(".photo-nav").children("li").each(function(a) {
        $(this).bind("click",
        function() {
...
var controlPicture = {
    ...
    changePic: function(f, a, c) {
        ...
        if (picList) {
            ...
            this.checkAndLoadImg(picList[h - 1].bigPic, document.getElementById("photo-box"));
            $("#showOriginal").attr("href", picList[h - 1].originalPic);
            $(".photo-nav").children("li").each(function() {
                $(this).attr("class", "")
            });
...
if (parseInt(selectKey) > 1) {
    ...
    controlPicture.checkAndLoadImg($("#photo-box").attr("src"), document.getElementById("photo-box"));
}
